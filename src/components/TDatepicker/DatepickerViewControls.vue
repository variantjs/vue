  ...
  <div class="flex px-3 pt-2">
    <template v-if="showControls">
      <button
        ...
        @click="toggleView"
      >
        <datepicker-view-controls-label control />
      </button>
    ...
    <datepicker-view-controls-label v-else />
  </div>
</template>
...
export default defineComponent({
  ...
  setup() {
    ...
    return { toggleView, nextAriaLabel, prevAriaLabel, toggleViewAriaLabel, nextGroupHandler, prevGroupHandler };
  },
});
</script>
